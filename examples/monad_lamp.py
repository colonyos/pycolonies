...
decide_lamp_state = Function(decide_lamp_state, colonyname, executortype="python")
set_lamp_state = Function("set_lamp_state", colonyname, executortype="lamp_executor")
